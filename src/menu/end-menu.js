export default class EndMenu {
  ...
  render() {
    ...
    bg.onload = () => {
      ...
      this.ctx.fillText(`You only put down ${this.game.kills} referee${this.game.kills !== 1 ? 's' : ''}, and beat Shaq ${this.game.bossKills} time${this.game.bossKills !== 1 ? 's' : ''}!`, this.game.canvas.width / 2 - 270, this.game.canvas.height / 2, 1000);
